...
$query = 'SELECT * FROM td_tax ORDER BY tax_id ASC';
    ...
    <tr>
       ...
       <?php if($_SESSION['user_type'] == 'Super') {?>
        <td class="center">
            ...
            <a class="btn btn-info" href="edit_service_tax.php?tax_id=<?php echo $data['tax_id'];?>">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                Edit
            </a>
            <a class="btn btn-danger confirm" href="delete_tax.php?tax_id=<?php echo $data['tax_id'];?>">
