...
$info = 'SELECT * FROM td_admin_info WHERE info_id='.$_REQUEST['info_id'];
$info_query = mysql_query($info, $con) or die(mysql_error());
$info_data = mysql_fetch_assoc($info_query);
if(isset($_POST['b_submit']) && $_POST['b_submit'] == 'submit') {
    ...
    $type = $_POST['type'];
	$sql = 'UPDATE td_admin_info SET email="'.$email.'",phn="'.$phn.'",conf_phn="'.$con_phn.'" WHERE info_id="'.$_REQUEST['info_id'].'"';
   ...
   <form action="" method="post" name="form1" enctype="multipart/form-data" onSubmit="return validate_admin_info()">
        ...
        <td class="center"> <div class="control-group">
                    ...
                    <div class="controls">
                     <select id="selectError" data-rel="chosen" name="type">
                            ...
                            <option value="<?php echo $info_data['type'];?>" selected><?php echo $info_data['type'];?> Admin</option>
    ...
    <tr>
        ...
        <td class="center"> <div class="form-group has-success col-md-4">
                    ...
                    <input type="text" name="txt_email" class="form-control email" id="inputSuccess1" value="<?php echo $info_data['email'];?>">
                </div></td>
     ...
     <tr>
        ...
        <td class="center"> 
                   <div class="form-group has-success col-md-4">
                    ...
                    <input type="text" name="txt_number" class="form-control phn" id="inputSuccess1" value="<?php echo $info_data['phn'];?>">
                </div>
       ...
       <tr>
        ...
        <td class="center"> 
                   <div class="form-group has-success col-md-4">
                    ...
                    <input type="text" name="txt_conf_number" class="form-control conphn" id="inputSuccess1" value="<?php echo $info_data['conf_phn'];?>">
                </div>
