...
$query = 'SELECT * FROM td_purchase WHERE purchase_id='$_REQUEST['b_id'];
...
?>
    <div>
        <ul class="breadcrumb">
            ...
            <li>
                <a href="#"><?php echo $data['customer_name'];?>'s Bill</a>
            </li>
        </ul>
    </div>
    ...
    <tr>
       ...
       <td class="center"><?php echo $data['type'];?></td>
        <td class="center">
            ...
            <a class="btn btn-info" href="edit_admin_info.php?blog_id=<?php echo $data['info_id'];?>">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                Edit
            </a>
            <a class="btn btn-danger" href="delete_admin_info.php?blog_id=<?php echo $data['info_id'];?>">
