...
$query = 'SELECT * FROM td_bank_details ORDER BY bnk_id ASC';
...
?>
    ...
    <tr>
        ...
        <td class="center"><?php echo $data['holder_name'];?></td>
        <td class="center"><?php echo $data['acc_number'];?></td>
       <td class="center"><?php echo $data['amount'];?></td>
        <?php if($_SESSION['user_type'] == 'Super') {?>
        <td class="center">
            
            <a class="btn btn-info" href="edit_bank_details.php?bank_id=<?php echo $data['bnk_id'];?>">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                Edit
            </a>
            <a class="btn btn-danger confirm" href="delete_bank_details.php?bank_id=<?php echo $data['bnk_id'];?>">
