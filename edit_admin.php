...
$query = 'SELECT * FROM td_admin WHERE admin_id='.$_REQUEST['admin_id'];
...
if(isset($_POST['txt_admin']) && $_POST['txt_admin'] == 'admin') {
    $user = $_POST['bname'];
     $pass = $_POST['bpass'];
$admin_update = 'UPDATE td_admin SET admin_user="'.$user.'",admin_pass="'.$pass.'" WHERE admin_id="'.$_REQUEST['admin_id'].'"';
    $admin_query = mysql_query($admin_update, $con) or die(mysql_error());
}
?>
<style type="text/css">
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i>Edit Sub admin</h2>
    ...
    <div class="box col-md-12">
    <div class="box-inner">
   <form action="" method="post" id="create_admin" name="form1" enctype="multipart/form-data" onSubmit="return edit_admin_valid()">
   <input type="hidden" name="SubAdmin" value="SubAdmin" />
    ...
    <tr>
        ...
        <td class="center"> <div class="form-group has-success col-md-4">
                    ...
                    <input type="text" name="bname" class="form-control bname" id="inputSuccess1" value="<?php echo $data['admin_user'];?>">
                </div></td>
     ...
     <tr>
        <td>Password</td>
        <td class="center"> <div class="form-group has-success col-md-4">
                  <input type="text" name="bpass" class="form-control bpass" id="inputSuccess1" value="<?php echo $data['admin_pass'];?>">
                 </div>   
                </td>
     ...
     <tr>
        <td></td>
        <td class="center">
        <input type="hidden" name="txt_admin" value="admin" />
