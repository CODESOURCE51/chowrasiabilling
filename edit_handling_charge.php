...
$query = 'SELECT * FROM td_handling_charge WHERE hc_id ='.$_REQUEST['hc_id'];
...
if(isset($_POST['b_submit']) && $_POST['b_submit'] == 'submit') {
	...
	$sql = 'UPDATE td_handling_charge SET sc_charge="'.$sc.'",handling_sc="'.$hsc.'",dlvry_sc="'.$dsc.'",air_sc_charge="'.$asc.'",air_handling_sc="'.$ahsc.'",air_dlvry_sc="'.$adsc.'" WHERE hc_id='.$_REQUEST['hc_id'];
   ...
   <form action="" method="post" name="form1" enctype="multipart/form-data" onSubmit="return validate_handling_charges()">
    ...
    <tr>
        ...
        <td class="center"> <div class="form-group has-success col-md-4">
                    ...
                    <input type="text" name="txt_service_charge" class="form-control service_charge" id="inputSuccess1" value="<?php echo $data['sc_charge'];?>">
                </div></td>
     ...
     <tr>
        ...
        <td class="center"> 
                   <div class="form-group has-success col-md-4">
                    ...
                    <input type="text" name="txt_handling" class="form-control handling" id="inputSuccess1" value="<?php echo $data['handling_sc'];?>">
                </div>
       ...
       <tr>
        ...
        <td class="center"> 
                   <div class="form-group has-success col-md-4">
                    ...
                    <input type="text" name="txt_delvry_sc" class="form-control delvry_sc" id="inputSuccess1" value="<?php echo $data['dlvry_sc'];?>">
                </div>
     ...
     <tr>
        ...
        <td class="center"> <div class="form-group has-success col-md-4">
                    ...
                    <input type="text" name="txt_aservice_charge" class="form-control aservice_charge" id="inputSuccess1" value="<?php echo $data['air_sc_charge'];?>">
                </div></td>
     ...
     <tr>
        ...
        <td class="center"> 
                   <div class="form-group has-success col-md-4">
                    ...
                    <input type="text" name="txt_ahandling" class="form-control ahandling" id="inputSuccess1" value="<?php echo $data['air_handling_sc'];?>">
                </div>
       ...
       <tr>
        ...
        <td class="center"> 
                   <div class="form-group has-success col-md-4">
                    ...
                    <input type="text" name="txt_adelvry_sc" class="form-control adelvry_sc" id="inputSuccess1" value="<?php echo $data['air_dlvry_sc'];?>">
                </div>
