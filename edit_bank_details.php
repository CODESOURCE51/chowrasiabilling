...
$query = 'SELECT * FROM td_bank_details WHERE bnk_id='.$_REQUEST['bank_id'];
...
if(isset($_POST['b_submit']) && $_POST['b_submit'] == 'submit') {
	...
	$sql = 'UPDATE td_bank_details SET bank_name="'.$bank.'",holder_name="'.$holder.'",acc_number="'.$number.'",amount="'.$amount.'",available_bal="'.$amount.'" WHERE bnk_id='.$_REQUEST['bank_id'];
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i>Edit Bank details</h2>
   ...
   <form action="" method="post" name="form1" enctype="multipart/form-data" onSubmit="return validate_bank()">
    ...
    <tr>
        ...
        <td class="center"> <div class="form-group has-success col-md-4">
                    ...
                    <input type="text" name="txt_bnkname" class="form-control bnkname" id="inputSuccess1" value="<?php echo $data['bank_name'];?>">
                </div></td>
     ...
     <tr>
        ...
        <td class="center"> 
                   <div class="form-group has-success col-md-4">
                    ...
                    <input type="text" name="txt_acc_name" class="form-control acc_name" id="inputSuccess1" value="<?php echo $data['holder_name'];?>">
                </div>
       ...
       <tr>
        ...
        <td class="center"> 
                   <div class="form-group has-success col-md-4">
                    ...
                    <input type="text" name="txt_acc_number" class="form-control acc_number" id="inputSuccess1" value="<?php echo $data['acc_number'];?>">
                </div>
       ...
       <tr>
        ...
        <td class="center"> 
                   <div class="form-group has-success col-md-4">
                    ...
                    <input type="text" name="txt_amnt" class="form-control amnt" id="inputSuccess1" value="<?php echo $data['amount'];?>">
                </div>
